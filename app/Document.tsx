...
import CountryPicker, { CountryCode } from 'react-native-country-picker-modal'; // Import CountryCode
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.description}>
          If you can’t find your document type or country of issue, contact support.
        </Text>

        {/* Country Selector */}
        <Text style={styles.subLabel}>Select country where your ID document was issued.</Text>
        <TouchableOpacity
        ...
        <Text style={styles.subLabel}>Click any below to select document type</Text>
        ...
        <Text style={styles.footerText}>
          On clicking continue, you will be prompted to use your camera, capture a selfie of yourself
          and to provide your govt. issued ID for account verification.
        </Text>
      </ScrollView>

      {/* Continue Button */}
      <TouchableOpacity
        style={[styles.continueButton, !selectedDocument && styles.disabledButton]}
