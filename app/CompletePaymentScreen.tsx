    ...
    <View style={styles.container}>
     ...
     <View style={styles.timerContainer}>
          ...
          <View style={styles.timer}>
            <Text style={styles.timerBox}>{String(minutes).padStart(2, '0')}</Text>
            <Text style={styles.colon}>:</Text>
            <Text style={styles.timerBox}>{String(seconds).padStart(2, '0')}</Text>
          </View>
        </View>
      ...
      <View style={styles.instructionsContainer}>
       <View style={styles.dotContainer}>
        ...
        <Text style={styles.instructionText}>
            Please transfer Asset to the address below or scan the QR code to make payment.
        </Text>
       </View>
       ...
       <View style={styles.dotContainer}>
        <View style={styles.dot}></View>
        <Text style={styles.instructionText}>
          After you transfer, please ensure you fill in the transaction info for your payment to help us confirm your order.
        </Text>
       </View>
       ...
       <View style={styles.dotContainer}>
        <View style={styles.dot}></View>
        <Text style={styles.instructionText}>
          Note: This order will be automatically cancelled if the button is not clicked by the deadline.
        </Text>
       </View>
      ...
      <View style={styles.paymentDetailsContainer}>
        ...
        <DetailRow label="Price" value="1,234,457.897 NGN" valueStyle={styles.paymentValue} />
      ...
      <View style={styles.walletContainer}>
        <View style={styles.addressContainer}>
            <Text style={styles.address}>xg60d34fg6DFw465sddtf0Q</Text>
            <AntDesign name='copy1' size={20} color={'#666'} />
        </View>
        ...
        <InputField
          ...
          placeholder="0d34fg6DFw465sddtf0Q"
        />
         <InputField
        ...
        />
        <Text style={styles.uploadLabel}>Screenshot of successful transfer</Text>
     ...
     <View style={styles.bottomSheetContent}>
            ...
            <Text style={styles.successBottomSheetHeaderP}>Your order has been completed</Text>
        ...
        <BottomSheet isVisible={isSuccessVisible} onBackdropPress={() => setIsSuccessVisible(false)}>
          <View style={styles.bottomSheetContent}>
              ...
              <Image source={require('../assets/icons/cancel-icon.png')} style={styles.logo} />
              

            <Text style={styles.successBottomSheetHeader}>Your order has been cancelled</Text>
            ...
            <View style={styles.successBottomSheetContainer}>
                ...
                <View style={styles.flex}>
                <Text style={styles.successBottomSheetText}>Order time</Text>
                <Text style={styles.successBottomSheetText}>2024-03-26 17:23:45</Text>
                </View>
...
const DetailRow: React.FC<{ label: string; value: string; valueStyle?: any; isQrCode?: boolean }> = ({
  label,
  value,
  valueStyle,
  isQrCode,
...
const InputField: React.FC<{ label: string; value: string; onChangeText: (text: string) => void; placeholder: string }> = ({
  label,
  value,
  onChangeText,
  placeholder,
