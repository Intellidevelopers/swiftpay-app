...
const KycLevelThree = () => {
    ...
    const [transactionPurpose, setTransactionPurpose] = useState<string>('Personal');
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.subTitle}>
          Check your <Text style={styles.highlight}>National ID</Text> Information
        </Text>
       ...
       <View style={styles.genderContainer}>
       <RadioButton.Group onValueChange={value => setTransactionPurpose(value)} value={transactionPurpose}>
          <View style={styles.radioButtonRow}>
        ...
        <View style={styles.genderContainer}>
        <RadioButton.Group onValueChange={value => setOccupation(value)} value={occupation}>
          <View style={styles.radioButtonRow}>
        ...
        <RadioButton.Group onValueChange={value => setProfit(value)} value={profit}>
          <View style={styles.radioButtonRow}>
        ...
        <View style={styles.bottomPagination}>
          ...
          <TouchableOpacity onPress={() => setModalVisible(true)}>
            <Text style={styles.navigationButton}>Confirm</Text>
          </TouchableOpacity>
      ...
      >
        <View style={styles.modalContainer}>
          ...
          <Image source={require('../assets/verified.png')} style={styles.mock} />
