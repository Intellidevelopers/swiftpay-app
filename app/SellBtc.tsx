      ...
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.priceSection}>
            ...
            <Text style={styles.priceValue}>{price} NGN</Text>
          </View>
          ...
          {/* Address Input */}
          <Text style={styles.paymentText}>Amount to sell in USD</Text>
          <TextInput 
            style={styles.input}
            placeholder="$120"
          ...
          <View style={styles.estimate}>
            ...
            <Text style={styles.est}>-- NGN</Text>
          </View>

          <Text style={styles.paymentText}>Amount of BTC to send</Text>
          {/* Input with "NGN" and "All" Pressable */}
          <View style={styles.inputContainer}>
            <TextInput 
              style={[styles.flexInput]}
              value='0.98655788 BTC'
              placeholderTextColor="#666"
          ...
          {/* Sell Button */}
          <TouchableOpacity style={styles.SellButton} onPress={() => router.push('/CompletePaymentScreen')}>
            <Text style={styles.SellButtonText}>Proceed</Text>
          </TouchableOpacity>

          {/* Note at the Bottom */}
          <Text style={styles.noteBottom}>Send to the wallet Address above and get paid in your SwiftPay Acoount</Text>
        </ScrollView>
