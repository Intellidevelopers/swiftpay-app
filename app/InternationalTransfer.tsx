...
// Define type for transaction item
...
const InternationalTransfer = () => {
  ...
  // Define render function with typed parameter
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <ImageBackground
        ...
        imageStyle={{ borderRadius: 10, alignSelf: "flex-end", left: 150, width: '70%', height: '70%', top: 30 }}
      >
        <View style={styles.dashboardContent}>
          <View style={styles.flexTitle}>
            ...
            <Image source={require('../assets/swiftpay-logo.png')} style={styles.logo} />
          </View>
